...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        .withKP(11).withKI(0).withKD(0.0)
        .withKS(0.32).withKV(0.6).withKA(0);
    ...
    private static final double kFrontLeftEncoderOffset = 0.1159;  // on alphabot naybe 0.3012 or from cancoder the value there is -0.1159
    ...
    private static final double kFrontRightEncoderOffset = -0.0200; // alphabot maybe -0.3486 or from cancoder the value there is 0.0200
    ...
    private static final double kBackLeftEncoderOffset = 0.1979; // on alphabot maybe -0.6377 or from cancoder the value there is -0.1979
    ...
    private static final double kBackRightEncoderOffset = 0.0957;  // on alphabot maybe 0.3388 mayve cancoder value there is -0.0957 
